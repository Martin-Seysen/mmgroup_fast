...
from mmgroup import MM, MM0, MMVector, MMSpace
...
def write_vector_59_mod3(g, v, ga, yx):
    ...
    print(HEADER, file = f)
    entries = [("G59", a_g), ("V59", a_v), ("A59", a_ga), ("YX", yx)]
...
####################################################################
####################################################################
# Main program for testing and function find_vector_p_mod3
####################################################################
####################################################################
...
if __name__ == "__main__":
    ...
    if "-w" in sys.argv:
        ...
        try:
            #print(s_g, s_v, s_ga)
            write_vector_59_mod3(g, v, ga, yx)
        except:
