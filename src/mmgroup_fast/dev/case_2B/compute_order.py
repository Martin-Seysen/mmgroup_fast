...
def compute_order_lin2_orbit(lin2_orbit, verbose = 0):
...
######################################################################
# This paragaph is out of date!!!!!!!!!!!!!
#
# Before this point the file is a verbatim copy of the file
# ...\order_monster\axis_orbits\axis\mat24_orbits.py
# of the accompanying code of the paper
# "The Order of the Monster Finite Simple Group"
# by G. Hoehn and martin Seysen
# 
######################################################################
...
def compute_order(g_list, verbose = 0):
    generators = [Xsp2_Co1(g) for g in g_list] 
    orbits = Orbit_Lin2(_map_generator, generators)
    a, b, c = compute_order_lin2_orbit(orbits, verbose)
    return a * b * c
